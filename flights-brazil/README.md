...
So, questions 1 to 4 proposed in a data structure activity related to graphs will be solved, studying several properties of this network: assortativity, degree assortativity, connected componentes and shortest path.
